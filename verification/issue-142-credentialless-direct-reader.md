...
- Base: `a6a57ebc40c1466eff82f938236b76a7c016a0e8`
- Stack parent: #141 credentialless managed-read capabilities
...
- `cargo test -p lake-sdk --lib`: PASS, 55 passed and 2 LocalStack-only tests
  ignored as designed.
- `mise run gate`: PASS: hooks, workspace all-target tests, CLI selftest, the
  three ignored ADBC interoperability tests, and site typecheck/test/build.
- `git diff --check`: PASS.
